...
if(isset($_GET['coditem']) && is_numeric($_GET['coditem'])){
    $coditem = $_GET['coditem'];
    $resultado = $producto->mostrarPorId($coditem);
    ...
    if(isset($_SESSION['carrito'])){ //SI EL CARRITO EXISTE
        ...
        if(array_key_exists($coditem,$_SESSION['carrito'])){
            actualizarProducto($coditem);
        }else{
            //  SI EL CARRITO NO EXISTE EN EL CARRITO
            agregarProducto($resultado, $coditem);
        }
                      ...
                      ?>
                        <tr>
                            <form action="actualizar_carrito.php" method="post">
                                ...
                                <td>
                                <input type="hidden" name="coditem"  value="<?php print $value['coditem'] ?>">
                                ...
                                <td>
                                    ...
                                    <a href="eliminar_carrito.php?coditem=<?php print $value['coditem']  ?>" class="btn btn-danger btn-xs">
