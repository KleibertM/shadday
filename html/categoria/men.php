...
<body>
  ...
  $stmt = $conexion->prepare("SELECT categoria, nombre, version, precio,coditem FROM item WHERE categoria = 9002");
  $stmt->execute();?>
  <?php include '../navbar.php'; ?>
    <div class="titulo-cat" >
      <h1 style = "text-align: center;" >Biblias de Caballeros</h1>
    </div>
    <div class="container" >
